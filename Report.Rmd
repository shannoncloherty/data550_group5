...
projectdata_greaterthan <- projectdata %>%
  filter(newvardata == "Greater than or equal to cutoff")
projectdata_lessthan <- projectdata %>%
  filter(newvardata == "Less than cutoff")
...
The median for those greater than or equal to `r params$var_cutoff` is equal to `r median(projectdata_greaterthan$days_stable)`. The median for those less than `r params$var_cutoff` is equal to `r median(projectdata_lessthan$days_stable)`.
